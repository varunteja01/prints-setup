    ...
    <View style={styles.footer2}>
      <View style={styles.container}>
        {/* <Text style={styles.total}>
          Rs. {convertNumToWords(footer.net_amount)}
        </Text> */}
        {gstEnabled == true ? (
          <Text style={styles.total}>
            CGST 2.50%{' '}
        ...
        >
          <Image style={{ height: '30px', width: '150px' }} src={block} />
      ...
      <View style={styles.middle_container}>
        ...
        <Text style={{ ...styles.forDetails, marginTop: '25px' }}>
          Pharmacist
        </Text>
      ...
      <View style={styles.right_head_container}>
        ...
        <Text style={styles.footer_heading}>CR/DB Notes&nbsp;:</Text>
        <Text style={styles.footer_heading}></Text>
        {/* <Text style={styles.saved_heading}>YOU SAVED&nbsp;:</Text> */}
        <Text style={styles.net_amount}>GRAND TOTAL&nbsp;:</Text>
      </View>

    ...
    <View style={styles.footer2}>
      <View style={styles.container}>
        <Text style={styles.verify}>
          Billed at : {moment(footer?.created_at).format('hh:mm A')}
        </Text>
      ...
      <View style={styles.container}>
        ...
        <Text style={{ ...styles.footer_heading1, width: '2.3%' }}>Bills</Text>
        ...
        ></Text>
        <Text style={{ ...styles.footer_heading1, paddingLeft: 2 }}>
          Last Receipt
        </Text>
        <Text style={styles.footer_icon1}>:</Text>
        <Text style={styles.footer_value_border1}></Text>
        <Text style={styles.blank}></Text>
        <Text style={styles.footer_heading}>DiscAmt(-)</Text>
        <Text style={styles.footer_icon}>:</Text>
        <Text style={styles.footer_value_border}>
          {show_total == true
      ...
      <View style={styles.footer4}>
        <View style={styles.tnc}>
          ...
          <Text style={{ padding: '2px 2px 0 2px', fontSize: 8 }}>
